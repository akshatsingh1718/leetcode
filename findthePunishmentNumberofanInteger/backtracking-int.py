...
class Solution:
    ...
    def punishmentNumber(self, n: int) -> int:
        ...
        def find_partition(num: int, target: int) -> bool:
            ...
            # num // 10 will eliminate last 1 digit
            # num % 10 will extract last 1 digit
            return (
                find_partition(num // 10, target - num % 10)
                or find_partition(num // 100, target - num % 100)
                or find_partition(num // 1000, target - num % 1000)
            )
