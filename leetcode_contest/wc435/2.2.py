...
class Solution:
    def maxDistance(self, s: str, k: int) -> int:
        ...
        def next_move(move: str):
            return (directions[move][0], directions[move][1])
        ...
        def find_max(
            ...
            for direction in directions:
                ...
                max_move_dist = max(
                    max_move_dist,
                    find_max(next_move_dist(ni, nj) + dist, new_k, si + 1),
                    next_move_dist(ni, nj),
                )
            return max_move_dist

        return find_max(0, k, 0)  # dist, k, si
