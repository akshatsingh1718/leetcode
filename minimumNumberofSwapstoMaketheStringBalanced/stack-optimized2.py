...
class Solution:
    ...
    Algorithm:
    ==========================
    (optimization is change stack list to stack int and stack will have the no of unmatched open [ brackets which is equal to unmatched closed ] since the question states that no of open and closed brackets is n/2)
